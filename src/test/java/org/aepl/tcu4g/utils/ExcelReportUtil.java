...
public class ExcelReportUtil {
	...
	private static int headerRow = 4;
	...
	private static void findColumns() {
		Row headerRow = currentSheet.getRow(ExcelReportUtil.headerRow); // 5th row (0-based index)
		if (headerRow == null) {
		...
		if (testCaseIdColumn == -1 || statusColumn == -1 || remarksColumn == -1) {
			throw new IllegalStateException("Required columns not found in the sheet. TestCaseID: " + testCaseIdColumn
					+ ", Status: " + statusColumn + ", Comment: " + remarksColumn);
		}
	}
	...
	public static void addTestResult(String testCaseId, String result, String remarks) {
